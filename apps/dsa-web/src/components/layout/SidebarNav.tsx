...
import { BarChart3, BriefcaseBusiness, Home, Landmark, LogOut, MessageSquareQuote, Settings2 } from 'lucide-react';
...
const NAV_ITEMS: NavItem[] = [
  ...
  { key: 'funds', label: '基金', to: '/funds', icon: BarChart3 },
  { key: 'fund-holdings', label: '基金持仓', to: '/fund-holdings', icon: Landmark },
